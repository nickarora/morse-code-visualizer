...
describe("Morse", () => {
  describe("Encoder", () => {
    describe("Read Signal Off", () => {
      describe("Start Time Precedes Stop Time", () => {
        const encoder = new Encoder(Duration.example())

        encoder.startSignalTime = Time.example({ offsetMilliseconds: 1 })
        encoder.stopSignalTime = Time.example({ offsetMilliseconds: 100 })
